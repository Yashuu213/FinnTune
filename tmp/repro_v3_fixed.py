...
def test_parse_v3_fixed(text):
    ...
    STOP_WORDS = [
        ...
        'gave', 'given', 'gave', 'diya', 'diye', 'mila', 'mila', 'mile', 'received', 'got', 'sent', 'bheja', 'bheje', 'pay', 'paid', 'transferred', 
    ...
    for seg in segments:
        ...
        is_debt = False; is_income = False; person_name = None; debt_type = None; found_category = None; found_via_marker = False
...
test_cases = [
    "10 main pizza ke liye rahul ko diye",
    "rahul ko 500 diye petrol bhara",
    "chai 10 maine pi",
    "100 pizza 200 burger",
    "mummy ko 500 diye swiggy",
    "paise mile 5000 salary"
]

for tc in test_cases:
    print(f"Input: {tc}")
    print(f"Output: {test_parse_v3_fixed(tc)}")
    print("-" * 30)
